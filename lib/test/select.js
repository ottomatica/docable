...
class Select {
    ...
    async selectAsFile(content, destination, user, persistent, target, opts = {insertafter:false, insertbefore: false})
    {
        return new Promise(async (resolve, reject) => 
        {
            try {
                let output = await this.op.file( content, destination, user, persistent, target, opts);
