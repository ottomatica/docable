                ...
                function(error, stdout, stderr) {
                  ...
                  MacCommand(instance,
                    function(error) {
                      ...
                      macProgress( Node.path.join(instance.path, 'Contents', 'MacOS') );

                      MacOpen(instance,
                        function(error, stdout, stderr) {
                          // Stop listening.
                          macProgressStop( Node.path.join(instance.path, 'Contents', 'MacOS') );
                          if (error) return end(error, stdout, stderr);
...
function macProgressStop(baseDirectory)
{
...
function macProgress(baseDirectory)
{
  let stdoutLines = 0;
  let stderrLines = 0;
