                ...
                function(error, stdout, stderr) {
                  ...
                  MacCommand(instance,
                    function(error) {
                      ...
                      progressWithFSWatch( Node.path.join(instance.path, 'Contents', 'MacOS') );

                      MacOpen(instance,
                        function(error, stdout, stderr) {
                          // Stop listening.
                          progressWithFSWatchStop( Node.path.join(instance.path, 'Contents', 'MacOS') );
                          if (error) return end(error, stdout, stderr);
...
function progressWithFSWatchStop(baseDirectory)
{
...
function progressWithFSWatch(baseDirectory)
{
  let stdoutLines = 0;
  let stderrLines = 0;
    ...
    function(error, uuid) {
      ...
      Node.fs.mkdir(instance.path,
        function(error) {
          ...
          // Watch stdout/stderr for changes and emit data events.
          progressWithFSWatch( instance.path );
                  ...
                  WindowsElevate(instance,
                    function(error, stdout, stderr) {
                      ...
                      WindowsWaitForStatus(instance,
                        function(error) {
                          progressWithFSWatchStop( instance.path );
                          if (error) return end(error);
