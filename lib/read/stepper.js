            ...
            switch (cell.type) {
                ...
                case 'script':
                {
                    if (cell.lang === "js") {
                        ...
                        let scriptPath = await cellTargetConnectorInstance.writeTempFile("docable.js", contentWrapedInAsync);
                        ...
                        satisfiedDeps = satisfiedDeps.dependencies ? Object.keys(satisfiedDeps.dependencies).filter(dep => satisfiedDeps.dependencies[dep].invalid == undefined || satisfiedDeps.dependencies[dep].invalid == false) : [];
                    ...
                    if (cell.lang === "ruby") {
                        let scriptPath = await cellTargetConnectorInstance.writeTempFile("docable.rb", cell.content);
