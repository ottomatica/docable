        ...
        for (const cell of cells) {
            ...
            switch (cell.type) {
                ...
                case 'script':
                {
                    ...
                    if (cell.lang === "python") {
                        let scriptPath = await cellTargetConnectorInstance.writeTempFile("docable.py", cell.content);
                    ...
                    if (cell.lang === "java") {
                        ...
                        let scriptPath = await cellTargetConnectorInstance.writeTempFile("docable.java", cell.content);
